...
const tesisData = [
  
    {
        ...
        nivel: "pregrado",
        anio: 2020,
        autor: "Roberto Antonio Cuellar Lozano",
    ...
    {
        titulo: "Mezcla de seis ondas en un cristal de BSO, estudio experimental de la polarización en configuración transversal y longitudinal",
        tipo: "tesis",
        resumen: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
        nivel: "pregrado",
        anio: 2016,
        autor: "Lorena Villamizar Florez",
        tutor: "Jorge Enrique Rueda P",
        cotutor: "",
    ...
    {
        titulo: "Implementación de un procesador óptico-virtual de encriptación de transformada conjunta para la generación de criptogramas camuflados",
        tipo: "tesis",
        resumen: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
        nivel: "pregrado",
        anio: 2016,
    ...
    {
        titulo: "Neutrinos pesados de Majorana y el origen de la materia oscura en el paradigma de Freeze-in",
        tipo: "tesis",
        resumen: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
        nivel: "pregrado",
        anio: 2021,
    ...
    {
        titulo: "Trazado de rayos sismicos",
        tipo: "tesis",
        resumen: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
        nivel: "pregrado",
        anio: 2009,
